...
if cursor.fetchone()[0] != 0: #UPDATE a mii entry if it already exists, and give it the same entry number
	...
	cursor.execute("INSERT INTO artisan(nickname, country, wiino, mac, miidata)\
	VALUES(%s, %s, %s, %s, %s)", (nickname, country, wiino, macadr, miidata)) 
