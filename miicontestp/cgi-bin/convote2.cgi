...
def verifyMac(mac):  # verify macaddress is valid and from a Wii
    oui = ['0009BF', '001656', '0017AB', '00191D', '0019FD', '001AE9', '001B7A', '001BEA', '001CBE', '001DBC', '001E35', '001EA9', '001F32', '001FC5', '002147', '0021BD', '00224C', '0022AA', '0022D7', '002331', '0023CC', '00241E', '002444', '0024F3', '0025A0', '002659', '002709', '0403D6', '182A7B',
           '2C10C1', '34AF2C', '40D28A', '40F407', '582F40', '58BDA3', '5C521E', '606BFF', '64B5C6', '78A2A0', '7CBB8A', '8C56C5', '8CCDE8', '9458CB', '98B6E9', '9CE635', 'A438CC', 'A45C27', 'A4C0E1', 'B87826', 'B88AEC', 'B8AE6E', 'CC9E00', 'CCFB65', 'D86BF7', 'DC68EB', 'E00C7F', 'E0E751', 'E84ECE', 'ECC40D']
...
def returnFail():
    ...
    stdout.flush()
    stdout.buffer.write(bytes.fromhex(
...
if firstVote:
    try:
        if len(craftsno) == 2:
            ...
            craftsno.append(craftsno[0])
            craftsno.append(craftsno[0])
        cursor.execute('INSERT INTO convotes (id, craftsno1, craftsno2, craftsno3, mac, ip) VALUES (%s, %s, %s, %s, %s, %s)',
                       (contestno, craftsno[0], craftsno[1], craftsno[2], macadr, ip))  # log their vote
    except IndexError:
    ...
    cursor.execute(
        'SELECT craftsno1, craftsno2, craftsno3 FROM convotes WHERE mac = %s AND id = %s LIMIT 1', (macadr, contestno))
    ...
    cursor.execute('UPDATE convotes SET craftsno1 = %s, craftsno2 = %s, craftsno3 = %s WHERE mac = %s AND id = %s',
